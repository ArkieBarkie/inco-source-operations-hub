...
export default function Planning() {
  ...
  return <div className="container-page">
    <PageTitle eyebrow="Operationele afspraken" title="Planning" description="Bloktijden en werkzaamheden voor leveringen, ophalingen, klantbezorgingen en voorraadverplaatsingen." action={canEdit?<button onClick={() => setForm(true)} className="rounded-xl bg-navy px-5 py-3 font-bold text-white">+ Activiteit toevoegen</button>:undefined} />
    <div className="mb-5 flex flex-col justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm text-blue-950 md:flex-row md:items-center"><p><b>Planning is de afspraaklaag.</b> De zending blijft het leidende dossier voor transportstatus, aantallen en tracking.</p><span className="shrink-0 rounded-full bg-white px-3 py-1.5 text-xs font-bold text-blue-700">Bron: portaltest · Odoo nog niet gekoppeld</span></div>
