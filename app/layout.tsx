...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="nl" data-scroll-behavior="smooth"><body><OperationsProvider><Shell>{children}</Shell></OperationsProvider></body></html>}
