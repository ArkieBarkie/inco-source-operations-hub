...
export default function Ordercheck(){
  ...
  const rules=useMemo(()=>{
    const valueRules=incoterm==='EXW'
      ...
      : incoterm==='DAP'
        ? [
            {label:`Orderwaarde DAP minimaal € ${policy.dapExceptionMinimumOrderValue.toLocaleString('nl-NL')}`,ok:value>=policy.dapExceptionMinimumOrderValue},
            {label:'DAP-uitzonderingsakkoord vastgelegd',ok:dapApproved},
          ]
  ...
  return <div className="container-page">
    ...
    <p className="mt-5 text-xs leading-5 text-slate-500">Open punt: de exacte kostenopbouw van nettomarge en nettowinst is nog niet gedefinieerd. De check gebruikt de vastgelegde grenswaarden, niet een eigen winstberekening.</p>
  </div>
}
